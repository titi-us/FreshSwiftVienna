...
func createNode(currentNode: xmlNodePtr, inout parentDictionary: Dictionary<String, AnyObject>, parentContent: Bool) -> Dictionary<String, AnyObject>? {
    ...
    if attribute.getLogicValue() {
        ...
        var attributeArray:Array<Dictionary<String, AnyObject>> = Array<Dictionary<String, AnyObject>>()
        while attribute.getLogicValue() {
            ...
            if attributeArray.count > 0 {
                ...
                resultForNode.updateValue(attributeArray as AnyObject, forKey: NDHppleNodeKey.AttributeArray.toRaw())
            }
    ...
    if childNode {
        ...
        if childContentArray.count > 0 {
            ...
            resultForNode.updateValue(childContentArray as AnyObject, forKey: NDHppleNodeKey.Children.toRaw())
        }
    }
